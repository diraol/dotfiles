...
sudo aptitude install -y ruby rdoc irb git vim python-pip python-pip3 tmux exuberant-ctags
...
echo "09 - Updating homesick submodules"
cd ~/.homesick/repos/dotfiles/
git checkout personal
git submodule update --init --recursive
homesick symlink dotfiles

echo "10 - Installing vim plugins with Bundle/Vundle"
