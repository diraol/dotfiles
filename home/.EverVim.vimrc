...
" EverVim options {
    ...
    "   let g:evervim_bundle_groups=['general', 'appearance', 'writing',
    "   'youcompleteme', 'programming', 'python', 'javascript', 'typescript',
    "   'html', 'css', 'misc', 'go', 'rust', 'cpp', 'lua']
        let g:evervim_bundle_groups=['general', 'appearance', 'writing',
                    \ 'youcompleteme', 'programming', 'python', 'javascript',
                    \ 'html', 'css', 'misc', 'go', 'r']
    ...
    "   let g:evervim_light_background = 1
       let g:evervim_color_theme="gruvbox"
       let g:evervim_airline_theme="gruvbox"
    ...
    "   let g:evervim_font_size="12"
        let g:evervim_font="Inconsolata Nerd Font"
        let g:evervim_font_size="12"
    ...
    " Header constants for generating and updating the comment header
       let g:header_field_author = 'Diego Rabatone Oliveira'
       let g:header_field_author_email = 'diego.rabatone@cabify.com'
    ...
    " TMUX AND PANEL NAVIGATION CONFIGS
    ...
    " Vim Tmux navigation mappings
        nnoremap <silent> <S-Left> call :TmuxNavigateLeft<cr>
        nnoremap <silent> <S-Down> call :TmuxNavigateDown<cr>
        nnoremap <silent> <S-Up>  call :TmuxNavigateUp<cr>
        nnoremap <silent> <S-Right> call :TmuxNavigateRight<cr>
