...
#POWERLEVEL9K_BATTERY_ICON='\u'$BATTERY_ICON
...
plugins=(cp ssh-agent gpg-agent colorize git git-extras github jsontools virtualenvwrapper zsh-navigation-tools)
