...
#alias radar_vm_usp='ssh -i ~/.ssh/google_compute_engine.pem leofl@$RADARVMUSP -p60522'
#alias polignu_vm_usp='ssh -i ~/.ssh/google_compute_engine.pem leofl@$PGNUVMUSP -p60622'
